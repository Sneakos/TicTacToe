...
/**
 * Tic Tac Toe game with basic GUI and a working (at least, my idea of one) nerual AI
 * 
 * @author Alex
 * @date 2016
 */
...
public class NeuralGame extends JFrame implements ActionListener
{
     ...
     *
     */
    public void neuralTurn()
    {
        setTitle("Thinking...");
        choice = network.getMove(board);
